...
export default function EdenArtFrontPage() {
  return (
    <div className="bg-black">
      <div className=" ">
        <div className="fixed z-10 w-full bg-black opacity-80 h-16 mt-8">
          <div className="flex justify-between">
            <div className="flex items-center">
              <Link href="/">
                <img
                  src="logo.png"
                  className="h-16 sm:h-16 pl-4 sm:pl-24 pt-3 pb-3 object-contain"
                />
              </Link>
              <Link href="/">
        ...
        <section className="flex flex-col">
          <div className="text-white flex px-4 sm:px-24 mt-10 flex-col">
            {/* 1st section */}
            <div className="flex flex-col sm:flex sm:flex-row">
              <div className=" sm:w-1/2 pt-3 pb-3">
                <img
                  src="/img1.jpg"
                  className="rounded-2xl w-full h-auto object-cover"
                />
              </div>
              <div className="px-3 sm:pl-10 py-6 flex-grow">
            ...
            <div className="flex flex-col-reverse sm:flex sm:flex-row">
              <div className="px-3 sm:pr-10 py-6 flex-grow sm:text-right">
                <p className="mb-4 text-2xl font-semibold lg:text-4xl md:text-3xl ">
            ...
            {/* 3rd section */}
            <div className="mt-4 sm:mt-24 flex flex-col-reverse sm:flex-col">
              <div className="px-3 sm:pl-10 py-6 w-full flex justify-center sm:text-center flex-col sm:items-center">
                ...
                <p className="text-2xl text-white lg:text-2xl md:text-2xl font-extralight">
                  ...
                  that generate the most sublime and glorious image and video
                  art.
                </p>
            ...
            {/* 4th section */}
            <div className="flex mt-4 sm:mt-24 flex-col sm:flex sm:flex-row">
              <div className="sm:w-1/3 pt-3 pb-3">
                <img
                  src="/img4.png"
                  className="rounded-2xl w-full h-auto object-cover"
                />
              ...
              <div className="px-3 sm:pl-10 py-6 flex-grow">
                ...
                >
                  <p className="mt-4 sm:mt-20 sm:text-2xl underline">3D Art by Nico</p>
                </Link>
              </div>
            </div>

            {/* 5th section */}
            <div className="flex mt-4 sm:mt-24 flex-col-reverse sm:flex sm:flex-row">
              <div className="px-3 sm:w-2/3 pr-10 py-6 flex-grow sm:text-right">
                <p className="mb-4 text-2xl font-semibold lg:text-4xl md:text-3xl ">
